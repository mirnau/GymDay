...
This is an iteration of a dotnet MAUI project that I have worked on from time to time during my studies to learn concepts in dotnet. It's basically a playground where I test out things and experiment with MVVM architecture in dotnet MAUI and unit-testing with xUnit in dotnet MAUI.
The primary goal is not to end up with a product, but more so to play around and learn stuff.
